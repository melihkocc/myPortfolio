...
import vuejs from "@/public/images/vuejs.svg";
    ...
    <>
      ...
      >
        <SwiperSlide className="flex flex-col justify-center items-center">
          <Image src={laravel} style={{paddingLeft:"5.5px",paddingRight:"5.5px"}} alt="image" />
          <span style={{ color: "#ff4c5a" }} className="text-lg">
            Laravel
          </span>
        </SwiperSlide>
        ...
        <SwiperSlide className="flex flex-col justify-center items-center">
          ...
          <span style={{ color: "#72b545" }} className="text-lg">
            Spring Boot
          </span>
        </SwiperSlide>
        ...
        <SwiperSlide className="flex flex-col justify-center items-center">
          ...
          <span style={{ color: "#61dafb" }} className="text-lg">
            React.js
          </span>
        </SwiperSlide>
        ...
        <SwiperSlide className="flex flex-col justify-center items-center">
          <Image
            src={nextSvg}
            className="dark:bg-white rounded-lg py-1"
            alt="image"
            style={{ color: "white" }}
          />
        ...
        <SwiperSlide className="flex flex-col justify-center items-center">
          <Image src={vuejs} alt="image" />
          <span style={{ color: "#14c66d" }} className="text-lg">
            Vue.js
          </span>
        </SwiperSlide>
        ...
        <SwiperSlide className="flex flex-col justify-center items-center">
          ...
          <span className="text-lg text-black dark:text-cyan-400">
            React Native
          </span>
        </SwiperSlide>
        ...
        <SwiperSlide className="flex flex-col justify-center items-center">
          <Image
            src={expressSvg}
            className="dark:bg-white rounded-lg px-1"
            width={100}
            height={100}
            alt="image"
          />
        ...
        <SwiperSlide className="flex flex-col justify-center items-center">
          ...
          <span style={{ color: "#0ed7b5" }} className="text-lg">
            Tailwind
          </span>
        </SwiperSlide>
        ...
        <SwiperSlide className="flex flex-col justify-center items-center">
          ...
          <span style={{ color: 'purple' }} className="text-lg">
            Bootstrap
          </span>
        </SwiperSlide>
        ...
        <SwiperSlide className="flex flex-col justify-center items-center">
          ...
          <span style={{ color: "#e34f26" }} className="text-lg">
            HTML
          </span>
        </SwiperSlide>
        ...
        <SwiperSlide className="flex flex-col justify-center items-center">
          ...
          <span style={{ color: "#1c88c7" }} className="text-lg">
            CSS
          </span>
        </SwiperSlide>
        ...
        <SwiperSlide className="flex flex-col justify-center items-center">
          ...
          <span style={{ color: "#f0db4f" }} className="text-lg">
            Javascript
          </span>
        </SwiperSlide>
